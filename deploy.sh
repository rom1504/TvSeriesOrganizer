...
cp libicudata.so.51  libicuuc.so.51   libQt5DBus.so.5  libQt5Network.so.5  libQt5Quick.so.5 libicui18n.so.51  libQt5Core.so.5  libQt5Gui.so.5   libQt5Qml.so.5 libQt5Xml.so.5 libQt5Widgets.so.5 $p/
cd $p/..
